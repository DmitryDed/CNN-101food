...
def build_model():
 ...
 aug_data = tf.keras.layers.experimental.preprocessing.RandomRotation(factor=0.12, fill_mode='reflect',
 interpolation='bilinear', seed=None, name=None, fill_value=0.0)(inputs)
